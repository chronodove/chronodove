...
//sees if the webpage has finished loading all resources or not
window.addEventListener("load", () => {
    //define loader
    const LOADER = document.querySelector(".loader");
    //if it has finished loading, initialize the "loader-hidden" class
    LOADER.classList.add("loader-hidden");
    //checks to see if the transition is over and once it does...
    LOADER.addEventListener("transitionend", () => {
    //...completely remove loader element from html
