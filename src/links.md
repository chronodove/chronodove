...
---
## vs code extensions
- [better nunjucks](https://marketplace.visualstudio.com/items?itemName=ginfuru.better-nunjucks) - nunjucks syntax recognition and snippets
- [code spell checker](https://marketplace.visualstudio.com/items?itemName=streetsidesoftware.code-spell-checker) - spell checker with low false positives
- [image preview](https://marketplace.visualstudio.com/items?itemName=kisstkondoros.vscode-gutter-preview) - shows photo on side of code
- [live preview](https://marketplace.visualstudio.com/items?itemName=ms-vscode.live-server) - local/in app live server
- [live server](https://marketplace.visualstudio.com/items?itemName=yandeu.five-server) - browser live server
- [markdown all in one](https://marketplace.visualstudio.com/items?itemName=yzhang.markdown-all-in-one) - markdown snippets
